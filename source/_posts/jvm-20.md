...
categories:
  ...
  - 深入拆解 Java 虚拟机
toc: true
date: 2020-01-23 15:25:15
---

{% aplayer 音频20 郑雨迪 https://res001.geekbang.org/resource/audio/f6/87/f65dffa812b78be771e37de834e3f287.mp3 %}
...
![image.png](/images/2020/01/23/e14f7200-3db0-11ea-87eb-3d1d349c50f2.png)
...
![image.png](/images/2020/01/23/f30d3950-3db0-11ea-87eb-3d1d349c50f2.png)

# bar 方法的 IR 图

接下来，即时编译器便可以进行方法内联，把 bar 方法所对应的 IR 图纳入到对 foo 方法的编译中。具体的操作便是将 foo 方法的 IR 图中 5 号 Invoke 节点替换为 bar 方法的 IR 图。

![image.png](/images/2020/01/23/07e9f3e0-3db1-11ea-87eb-3d1d349c50f2.png)
...
![image.png](/images/2020/01/23/2ba068a0-3db1-11ea-87eb-3d1d349c50f2.png)

该 IR 图可以进一步优化（死代码消除），并最终得到这张极为简单的 IR 图：

![image.png](/images/2020/01/23/31f3abe0-3db1-11ea-87eb-3d1d349c50f2.png)
...
![image.png](/images/2020/01/23/67373b00-3db1-11ea-87eb-3d1d349c50f2.png)
