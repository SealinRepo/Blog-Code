...
categories:
  ...
  - 深入拆解 Java 虚拟机
toc: true
date: 2020-01-23 18:14:47
---

{% aplayer 音频36 郑雨迪 https://res001.geekbang.org/resource/audio/60/b4/600d2b337171381b5f16347bc8abc5b4.mp3 %}
...
当然，Metropolis 项目并非第一个提出 Java-on-Java 概念的项目。实际上，[JikesRVM 项目](https://www.jikesrvm.org/)和[Maxine VM](https://github.com/beehive-lab/Maxine-VM) 项目都已用 Java 完整地实现了一套 Java 虚拟机（后者的即时编译器 C1X 便是 Graal 编译器的前身）。
