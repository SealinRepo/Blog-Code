...
categories:
  ...
  - 深入拆解 Java 虚拟机
toc: true
date: 2020-01-23 16:27:34
---

{% aplayer 音频27 郑雨迪 https://res001.geekbang.org/resource/audio/8c/3d/8c26bebd8e5fa781cebcfe90ebfd943d.mp3 %}
...
![image.png](/images/2020/01/23/633ce240-3db9-11ea-87eb-3d1d349c50f2.png)
...
接下来，我们来实现一个处理@Adapt注解的处理器。该处理器将生成一个新的源文件，实现参数value所指定的接口，并且调用至被该注解所标注的方法之中。具体的实现代码比较长，建议你在[网页端](https://time.geekbang.org/column/108)观看。
